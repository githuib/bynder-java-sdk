...
public interface BynderApi {
    ...
    Observable<Response<SaveMediaResponse>> saveMedia(
    ...
    Observable<Response<Void>> uploadChunk(
     ...
     */
    @FormUrlEncoded
    @POST("/v7/file_cmds/upload/{fileId}/finalise")
    Observable<Response<Void>> finaliseUpload(
            @Path("fileId") UUID fileId,
            @FieldMap Map<String, String> params
    );
    ...
    Observable<Response<UploadRequest>> initUpload(@FieldMap Map<String, String> params);
     ...
     *
     * @param params {@link FieldMap} with parameters.
     * @return {@link Observable} with {@link FinaliseS3Response} information.
     */
    @FormUrlEncoded
    @POST("/api/v4/upload/")
    Observable<Response<FinaliseS3Response>> finaliseS3Upload(@FieldMap Map<String, String> params);
